...
public class CategoryController {
    ...
    public Result<List<Category>> getCategories() {
        // 先从Redis缓存中获取
        String cacheKey = "category:list:b";
    ...
    public Result<Boolean> save(@RequestBody Category category) {
        ...
        // 清除列表缓存
        if (result) {
            redisTemplate.delete("category:list:b");
    ...
    public Result<Boolean> update(@RequestBody Category category) {
        ...
        if (result && category.getId() != null) {
            redisTemplate.delete("category:b:" + category.getId());
            redisTemplate.delete("category:list:b");
    ...
    public Result<Boolean> delete(@PathVariable Integer id) {
        ...
        // 清除缓存
        if (result) {
            redisTemplate.delete("category:b:" + id);
            redisTemplate.delete("category:list:b");
    ...
    public Result<String> clearCache() {
        // 清除所有以 category:b: 开头的键
        java.util.Set<String> keys = redisTemplate.keys("category:b:*");
